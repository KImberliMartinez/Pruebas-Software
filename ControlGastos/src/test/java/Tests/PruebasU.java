...
//        Usuarios nuevoUsuario = new Usuarios();
//        nuevoUsuario.setUsuario("testUsuario");
//        nuevoUsuario.setContra("password");
//
//        // Agregar el usuario
//        usuarioDAO.AgregarUsuario(nuevoUsuario);
//
//        // Verificar que el ID del usuario es mayor que 0 (es decir, el usuario fue agregado correctamente)
//        long idUsuario = usuarioDAO.obtenerIDusuario("testUsuario", "password");
//        assertNotEquals(0, idUsuario, "El ID del usuario debe ser mayor que 0 si se agregó correctamente.");
//    }
//
//
//@Test
...
//    
//    GastosDAO gastosDAO = new GastosDAO();
//    gastosDAO.Eliminar(gastoId);
//    
//    // Verifica que el gasto ya no existe en la base de datos
//    Gastos gastoEliminado = gastosDAO.obtenerLista(1L).stream()
//                                       .filter(g -> g.getId().equals(gastoId))
//                                       .findFirst()
//                                       .orElse(null);
//    
//    assertNull(gastoEliminado, "El gasto debe haber sido eliminado.");
//}
//
//@Test
//public void testObtenerGastosTotalesPorPeriodo() {
//    Date inicio = new Date(2024, 11, 1); // Fecha de inicio
//    Date fin = new Date(2024, 11, 30);  // Fecha de fin
//    
//    GastosDAO gastosDAO = new GastosDAO();
//    
//    // Llama al método y obtiene el total de gastos
//    Double totalGastos = gastosDAO.obtenerGastosTotalesPorPeriodo(inicio, fin);
//    
//    // Verifica que el total de gastos no sea nulo
//    assertNotNull(totalGastos);
//    assertTrue(totalGastos >= 0, "El total de gastos debe ser mayor o igual a 0.");
//}
//
//@Test
...
//    GastosDAO gastosDAO = new GastosDAO();
//    
//    // Llama al método para obtener los gastos totales por usuario
//    Double totalGastos = gastosDAO.GastosPorUusario(usuarioId);
//    
//    // Verifica que el total de gastos sea mayor o igual a 0
//    assertNotNull(totalGastos);
//    assertTrue(totalGastos >= 0, "El total de gastos por usuario debe ser mayor o igual a 0.");
//}
//
//@Test
...
//    GastosDAO gastosDAO = new GastosDAO();
//    
//    // Llama al método para obtener los gastos por categoría y usuario
//    Double totalGastosCategoria = gastosDAO.GastosPorCategoriYusuario(usuarioId, categoria);
//    
//    // Verifica que el total de gastos sea mayor o igual a 0
//    assertNotNull(totalGastosCategoria);
//    assertTrue(totalGastosCategoria >= 0, "El total de gastos por categoría y usuario debe ser mayor o igual a 0.");
//}
//
//
//
